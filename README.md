...
Enter the relevant details in the "Create Invoice" tab.
In the "Invoices" tab, click on the "Edit" button to make modifications.
Add the necessary items to the invoice.
In the "Invoices" tab, click on the button responsible for downloading the invoice.
You're done! You can open the downloaded PDF file and print the VAT invoice.
General Information
